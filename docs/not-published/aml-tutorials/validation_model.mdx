---
id: aml_validation_model
title: AML validation model
hide_title: true
---
...
Both the data graph and the shapes graph can be serialised using AMF as [JSON-LD](https://www.w3.org/TR/json-ld/) documents containing all the information about the graph.
