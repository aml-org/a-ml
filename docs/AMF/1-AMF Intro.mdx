...
## AMF project vision
[AML](https://a.ml/aml-spec) enables you to formally describe different kinds of models, whether syntactic models—specific to languags or specifications-or semantic models specific to industries and domains.
...
You can extend these models and others using custom [AML-defined models](https://a.ml/aml-spec). For formats and models that cannot be expressed with AML, you can create custom plugins.
