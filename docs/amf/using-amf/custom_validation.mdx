...
The Custom Validation feature is **no longer a part of the AMF core** as from version 5.x.x onwards. It has been extracted and published to a new project called [AMF Custom Validator](https://github.com/aml-org/amf-custom-validator).
