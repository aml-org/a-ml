...
## AMF project vision
[AML](https://aml-org.github.io/aml-spec) enables you to formally describe different kinds of models, whether syntactic models—specific to languages or specifications-or semantic models specific to industries and domains.
...
For example, the most used AMF module, the web-api module, can parse [RAML](https://raml.org/), [OAS](https://www.openapis.org) (formerly Swagger), and [AsyncAPI](https://www.asyncapi.com/) specification languages.
